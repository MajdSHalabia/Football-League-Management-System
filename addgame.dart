...
TextEditingController home_team = new TextEditingController();
TextEditingController away_team = new TextEditingController();
TextEditingController score = new TextEditingController();
TextEditingController game_date = new TextEditingController();
                            ...
                            Center(
                              child: TextButton(
                                ...
                                onPressed: () {
                                  ...
                                  String all_score = score.text;
                                  final dateList = all_score.split("-");
